...
class DashboardController extends Controller
{
    ...
    {
        // The 'admin.only' middleware already ensures only super_admin, receptionist, and tailor can access
        // Additional check for super_admin only if this is exclusive super admin area
        // For now, allow all three roles as they should have different permission levels
    ...
    private function getDashboardData()
    {
        ...
        $topProducts = collect([]);
        try {
            $topProductsData = DB::table('products')
                ->selectRaw('products.id, products.name, products.price, products.slug, COUNT(order_items.id) as order_count')
