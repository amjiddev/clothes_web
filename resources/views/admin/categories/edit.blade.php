...
<div class="container-fluid">
    ...
    <div class="page-header mb-4">
        <div class="row align-items-center">
            <div class="col">
                <h1 class="page-title"><i class="fas fa-edit me-2"></i>Edit Category</h1>
    ...
    <div class="row">
                    ...
                    <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                   id="name" name="name" value="{{ old('name', $category->name) }}" placeholder="e.g., Shalwar Kameez" required>
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      id="description" name="description" rows="4" placeholder="Category description">{{ old('description', $category->description) }}</textarea>
                            @error('description')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <!-- Image -->
                        <div class="mb-3">
                            <label for="image" class="form-label fw-bold">Change Category Image</label>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow">
                ...
                <div class="card-body">
                    <dl>
                        <dt>Products in this category:</dt>
                        <dd><strong>{{ $productCount }}</strong></dd>
