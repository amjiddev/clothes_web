...
<div class="container-fluid">
    ...
    <div class="page-header mb-4">
        <h1 class="page-title"><i class="fas fa-edit me-2"></i>Edit Product</h1>
    ...
    <div class="row">
                    ...
                    <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('fabric_type') is-invalid @enderror" id="fabric_type" name="fabric_type">
                                            ...
                                            <option value="{{ $fabric }}" {{ $product->fabric_type == $fabric ? 'selected' : '' }}>
                                                {{ $fabric }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="size_{{ $size }}" name="available_sizes[]" value="{{ $size }}" {{ in_array($size, $product->available_sizes ?? []) ? 'checked' : '' }}>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">Rs.</span>
                                            <input type="number" step="0.01" class="form-control @error('discount_price') is-invalid @enderror" id="discount_price" name="discount_price" value="{{ $product->discount_price }}">
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('stock_quantity') is-invalid @enderror" id="stock_quantity" name="stock_quantity" value="{{ $product->stock_quantity }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                @if($product->image)
                                <div class="mb-3">
                                    <p class="fw-bold text-muted">Current Image:</p>
                                    <img src="{{ $product->image_url }}" alt="{{ $product->name }}" class="img-thumbnail rounded" width="150" style="object-fit: cover;">
                                </div>
                                @endif
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <p class="fw-bold text-muted">Current Gallery:</p>
                                    <div class="row">
                                        @foreach($product->gallery as $img)
                                        <div class="col-md-3 mb-3">
                                            <img src="{{ asset('storage/' . $img) }}" alt="Gallery" class="img-thumbnail rounded w-100" style="object-fit: cover; height: 100px;">
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow mb-3">
                <div class="card-body">
                    ...
                    <ul class="small text-muted list-unstyled">
                        <li class="mb-2"><strong>Created:</strong> {{ $product->created_at->format('M d, Y') }}</li>
                        <li class="mb-2"><strong>Last Updated:</strong> {{ $product->updated_at->format('M d, Y') }}</li>
                        <li class="mb-2"><strong>Stock Status:</strong> 
                            <span class="badge bg-{{ $product->stock_status_badge }}">{{ $product->stock_status }}</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="card border-0 shadow">
                <div class="card-body">
                    <h5 class="card-title fw-bold mb-3">
                        <i class="fas fa-warning me-2"></i>Caution
                    </h5>
                    <p class="small text-muted mb-0">Changing product details may affect customer orders and reviews. Update carefully.</p>
                </div>
            </div>
        </div>
    </div>
