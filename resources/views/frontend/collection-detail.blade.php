...
<nav aria-label="breadcrumb" style="background: #f8f9fa; padding: 15px 0; border-bottom: 1px solid #e0e0e0;">
    <div class="container">
        <ol class="breadcrumb mb-0" style="background: transparent; padding: 0;">
            ...
            <li class="breadcrumb-item"><a href="{{ route('collections') }}" style="color: var(--primary-dark); text-decoration: none;">Collections</a></li>
            <li class="breadcrumb-item active" aria-current="page" style="color: var(--accent-gold); font-weight: 600;">{{ $title }}</li>
        </ol>
    </div>
</nav>
...
<section class="section-padding" style="background: white; padding: 60px 0;">
    <div class="container">
        ...
        <div class="row mb-5 align-items-center" style="border-bottom: 2px solid var(--accent-gold); padding-bottom: 20px;">
            ...
            <div class="col-md-6">
                <form method="GET" action="{{ url()->current() }}" class="d-flex justify-content-end align-items-center" style="gap: 12px;">
                    <!-- Search Bar -->
                    ...
                    <select name="sort" class="form-select" style="width: auto; border-color: var(--accent-gold); font-size: 0.9rem; flex-shrink: 0;" onchange="this.form.submit()">
                        ...
                        @elseif($collectionType == 'summer-2026')
        ...
        <div class="text-center py-5">
            ...
            <p class="text-muted" style="font-size: 1.1rem;">No products found in this collection.</p>
            <a href="{{ route('collections') }}" class="btn-premium mt-3">Browse All Collections</a>
        </div>
        @endif
    </div>
</section>
...
function clearSearchText() {
    ...
    searchInput.focus();
    // Redirect to current page without search
